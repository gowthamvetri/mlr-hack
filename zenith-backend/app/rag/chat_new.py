...
class RAGChatService:
    ...
    async def answer_question(
        ...
        """
        Answer user question using retrieval + Gemini formatting
        ...
        try:
            ...
            if use_rag:
                # Retrieval + Formatting: Search DB → Format with Gemini
                ...
                logger.info(f"📝 Formatting {len(context_chunks)} retrieved documents with Gemini")
