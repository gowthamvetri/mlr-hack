    ...
    <DashboardLayout role="seating_manager" userName={user?.name}>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500">View and manage your seating manager profile</p>
        </div>
        {!isEditing ? (
          <button
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 to-purple-700 p-8 text-center">
              ...
              <p className="text-purple-100 mt-1">Seating Manager</p>
            </div>
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-medium text-gray-800">Seating Manager</p>
                </div>
              </div>
            </div>
          </div>
