      ...
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1 text-lg">View and manage your seating manager profile</p>
          </div>
          {!isEditing ? (
            <button
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 border border-gray-300 text-gray-700 rounded-xl font-semibold hover:bg-gray-50 transition-all"
              >
                <X className="w-5 h-5" />
                Cancel
              </button>
              <button
                ...
                disabled={saving}
                className="flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-xl font-semibold shadow-lg shadow-primary-200 transition-all disabled:opacity-50"
              >
          ...
          <div className="lg:col-span-1">
            <div className="glass-card rounded-2xl tilt-card overflow-hidden">
              <div className="bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800 p-8 text-center">
                ...
                <p className="text-primary-100 mt-1 flex items-center justify-center gap-2">
                ...
                {profile.office && (
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-gray-800">{profile.office}</p>
                    </div>
                  </div>
                )}
          ...
          <div className="lg:col-span-2">
            <div className="glass-card rounded-2xl tilt-card overflow-hidden">
              <div className="p-6 border-b border-gray-100">
                ...
                <p className="text-sm text-gray-500 mt-1">{isEditing ? 'Update your details below' : 'View your profile details'}</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.name || '-'}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.phone || '-'}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.office || '-'}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    {isEditing ? (
                      ...
                      <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.gender || '-'}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.address || '-'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800 font-medium">{profile.bio || '-'}</p>
                  )}
                </div>
              </form>
            </div>
