  ...
  return (
    <DashboardLayout title="Dashboard">
      <div className="mb-8 animate-fade-in">
        <h1 className="text-3xl font-bold text-gray-900 mb-2 tracking-tight">Welcome back, {user?.name?.split(' ')[0]}! 👋</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-6 text-white shadow-xl hover:scale-[1.02] transition-transform duration-300 animate-slide-in-up group" style={{ animationDelay: '0ms' }}>
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-200">Daily Streak</h3>
          ...
          <div className="flex items-baseline gap-2">
            <p className="text-5xl font-bold mb-1 tracking-tight">{streak}</p>
            <span className="text-base text-gray-400 font-medium">days</span>
          </div>
          <p className="text-gray-400 text-sm mt-2 font-medium">Keep it up!</p>
        </div>

        {/* Skills Gained */}
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 animate-slide-in-up group hover-card" style={{ animationDelay: '100ms' }}>
          <div className="flex items-center justify-between mb-4">
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2 tracking-tight">{skillsGained}</p>
          <p className="text-gray-500 text-sm font-medium">New skills this month</p>
        </div>

        {/* Upcoming Exams */}
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 animate-slide-in-up group hover-card" style={{ animationDelay: '200ms' }}>
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-700">Exams</h3>
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2 tracking-tight">{exams.length}</p>
          <p className="text-gray-500 text-sm font-medium">Upcoming scheduled</p>
        </div>

        {/* Profile Score */}
        <div className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 animate-slide-in-up group hover-card" style={{ animationDelay: '300ms' }}>
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-bold text-gray-700">Profile Score</h3>
          ...
          <p className="text-4xl font-bold text-gray-900 mb-2 tracking-tight">{profileScore}%</p>
          <p className="text-gray-500 text-sm font-medium">Complete your profile</p>
        </div>
      </div>
      ...
      <div className="mb-8 animate-fade-in delay-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group hover-card">
            <div className="p-8">
              <div className="flex items-start justify-between mb-8">
                ...
                <span className="px-4 py-1.5 bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-wide rounded-full">
                  Advanced Learner
                </span>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-8">
                <div className="bg-gray-50 rounded-2xl p-4 text-center group-hover:bg-primary-50/30 transition-colors">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button className="flex items-center justify-center gap-2 px-4 py-3 bg-gray-900 text-white rounded-xl font-bold hover:bg-black transition-all shadow-lg active:scale-95 group/btn">
                  View Details
      ...
      <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-8 mb-8 hover-card animate-fade-in delay-300">
        ...
        {/* Next Milestone CTA */}
        <div className="mt-10 bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-6 flex flex-col sm:flex-row items-center gap-6 shadow-xl shadow-primary-200 text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8 animate-fade-in delay-500">
        <div className="lg:col-span-2 bg-white rounded-3xl shadow-sm border border-gray-100 p-8 hover-card">
        ...
        {/* Mini Calendar */}
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover-card h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover-card">
