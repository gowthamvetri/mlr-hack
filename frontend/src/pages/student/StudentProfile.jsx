        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div className="bg-gradient-to-r from-primary-600 to-primary-700 p-8 text-center">
              ...
              <p className="text-primary-100 mt-1">{profile.rollNumber || 'Student'}</p>
            </div>
              ...
              {profile.year && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-gray-800">{profile.year}</p>
                  </div>
                </div>
              )}
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800">{profile.rollNumber || '-'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800">{profile.department || '-'}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p className="px-4 py-3 bg-gray-50 rounded-xl text-gray-800">{profile.year || '-'}</p>
                  )}
                </div>
